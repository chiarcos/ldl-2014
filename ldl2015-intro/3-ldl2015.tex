...
\subsection{Key-Sun Choi: DBpedia  and Multilingualism}

In addition to full and short papers/dataset descriptions, LDL-2015 will feature Key-Sun Choi as an invited speaker on the topic of `DBpedia and Multilingualism'.

\paragraph{Biography}
Dr. Key-Sun Choi is professor of the School of Computing at the Korea Advanced Institute of Science and Technology (KAIST), Korea. 
% Key-Sun Choi is professor of the Korea Advanced Institute of Science and Technology (KAIST), Korea, since 1988, where he had been Head of Computer Science Department (2006-2011) and recently founded the KAIST research group on Open Knowledge Convergence (since 2012). Key-Sun Choi has contributed to Department of Knowledge Service Engineering and Graduate School of Information Security in KAIST as a Joint Professor.
His areas of expertise include natural language processing, ontology and knowledge engineering, semantic web and linked data, their infrastructures and text analytics. 
He served as President (2009-2010) of AFNLP (Asia Federation of Natural Language Processing), President (2006) of Korean Cognitive Science Society, and Secretary of ISO/TC37/SC4 for language resource management standards since 2002. 
He has been a member of the EU FP7 project LOD2: Creating Knowledge out of Interlinked Data (LOD2, 2010-2014,\footnote{
	\url{http://lod2.eu}
}, he is involved in the Exobrain project (since 2013),\footnote{
	\url{http://exobrain.kr/}
} and has been awarded the 2014 Eugen Wüster prize in the field of terminology science. 

His recent work is focusing on machine reading and question-answering for Korean language as well as cross-lingual aspects. 
...
Along with running the Korean DBpedia, recent Recent activities include
organizing a hackathon for Open Knowledge Bases and Question-Answering (OKBQA-2015)\footnote{
	\url{http://www.okbqa.org/}
} and a workshop for Natural Language Interfaces for the Web of Data (NLIWoD-2015).\footnote{
	\url{http://www.nliwod.org/}
} 
His group published CoreNet for the Korean-Japanese-Chinese WordNet and the KAIST Treebank. 
...
\paragraph{Abstract: `DBpedia and Multilingualism'}
Although the DBpedia ontology plays an important role in connecting between knowledges in Linked Data, its capability on bridging the gap between languages is limited. 
Due to substantial differences between languages, many users face difficulties in linking and aligning their knowledge and resources with the DBpedia ontology when creating Linked Data. 
We propose a way to pick out the elements (classes in particular) of the DBpedia ontology that are commonly and highly accessed to enhance multilingualism. 
This novel approach is based on the rank aggregation of Wikipedia in each language. 
In addition, ontological knowledge bases are enriched by a mapping from local properties to ontological properties.
